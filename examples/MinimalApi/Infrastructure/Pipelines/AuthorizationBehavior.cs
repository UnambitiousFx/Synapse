...
// generic constraint (where TRequest : IRequest<TResponse>, ISecuredRequest), emitting closed registrations.
...
/// <summary>
///     Authorization behavior for secured requests that produce a response.

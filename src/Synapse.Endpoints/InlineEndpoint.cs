...
///     </para>
/// </remarks>
public abstract class InlineEndpoint<TRequest, TResponse> : EndpointLifecycle<TRequest>
    where TResponse : notnull
{
    ...
    ///     already taken, and sealed, by <see cref="EndpointLifecycle{TRequest}" />: overloading it here

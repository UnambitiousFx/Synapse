...
/// <remarks>
///     See <see cref="InlineEndpoint{TRequest,TResponse}" />; this is the same tier for the arity
///     with no response body, including the trade-off that nothing wraps <see cref="ExecuteAsync" />.
/// </remarks>
public abstract class InlineEndpoint<TRequest> : EndpointLifecycle<TRequest>
{
    ...
    /// <remarks>See <see cref="InlineEndpoint{TRequest,TResponse}.ExecuteAsync" /> for the name.</remarks>

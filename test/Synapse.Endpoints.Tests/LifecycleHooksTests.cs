...
public sealed partial class LifecycleHooksTests
{
    ...
    public async Task HandleAsync_OnTheMappedTier_HandsTheBeforeHookTheWireDto()
    {
        ...
        // over the same EndpointLifecycle.RunLifecycleAsync every tier shares.
        Assert.Equal(
    ...
    ///     under test belongs to <c>EndpointLifecycle</c> and is identical for both tiers —
    ...
    /// </summary>
    [Get("/trace")]
    internal sealed partial class TracingEndpoint : BoundEndpoint<TraceQuery, string>
    {
    ...
    /// </summary>
    [Get("/bind-fail")]
    internal sealed partial class BindFailingEndpoint : BoundEndpoint<TraceQuery, string>
    {
        public override void Configure(IEndpointBuilder<string> builder)
        {
            builder.PostProcessor<TracingPostProcessor>();
    ...
    [Get("/bind-replace")]
    internal sealed partial class BindReplacingEndpoint : BoundEndpoint<TraceQuery, string>
    {
        public override ValueTask<BindResult<TraceQuery>> BindAsync(HttpContext context)
        {
            return new(BindResult<TraceQuery>.Failure("id", "is required."));
    ...
    [Post("/void-trace")]
    internal sealed partial class VoidTracingEndpoint : BoundEndpoint<TraceCommand>
    {
    ...
    /// <summary>See <see cref="BindFailingEndpoint" /> for why this tier.</summary>
    [Post("/void-bind-fail")]
    internal sealed partial class VoidBindFailingEndpoint : BoundEndpoint<TraceCommand>
    {
        public override void Configure(IEndpointBuilder builder)
        {
            builder.PostProcessor<TracingPostProcessor>();
    ...
    internal sealed partial class MappedTracingEndpoint
        : ContractEndpoint<TraceWireRequest, TraceQuery, string, string>
    {
        public override void Configure(IEndpointBuilder<string> builder)
        {
            builder.PreProcessor<TracingPreProcessor>()

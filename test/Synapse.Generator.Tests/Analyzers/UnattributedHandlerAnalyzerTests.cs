...
public sealed class UnattributedHandlerAnalyzerTests
{
    ...
    [Fact]
    public async Task Analyze_WithTheOnlyAttributedHandlerInAGeneratedFile_ReportsTheUnattributedOne()
    {
        // Arrange (Given)
        // The attribute in generated code is enough to show the assembly relies on the generator
        var generated = "// <auto-generated/>\n" + AnalyzerTestHelper.Preamble + Attributed;
        var handwritten = AnalyzerTestHelper.Preamble + Unattributed;

        // Act (When)
        var diagnostics = await AnalyzerTestHelper.RunFilesAsync<UnattributedHandlerAnalyzer>(
            ("Handlers.g.cs", generated), ("Second.cs", handwritten));
